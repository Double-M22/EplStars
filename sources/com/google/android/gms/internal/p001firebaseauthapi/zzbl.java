...
public final class zzbl {
    ...
    public static synchronized <KeyProtoT extends zzabg, PublicKeyProtoT extends zzabg> void zzb(zzbg<KeyProtoT, PublicKeyProtoT> zzbg, zzat<PublicKeyProtoT> zzat, boolean z) throws GeneralSecurityException {
        ...
        synchronized (zzbl.class) {
            ...
            if (zzb.containsKey("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey") && (zze2 = ((zzbk) zzb.get("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey")).zze()) != null) {
            ...
            if (!zzb.containsKey("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey") || ((zzbk) zzb.get("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey")).zze() == null) {
                zzb.put("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPrivateKey", new zzbi(zzbg, zzat));
            ...
            if (!zzb.containsKey("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPublicKey")) {
                zzb.put("type.googleapis.com/google.crypto.tink.EciesAeadHkdfPublicKey", new zzbh(zzat));
            }
    ...
    private static synchronized void zzo(java.lang.String r6, java.lang.Class<?> r7, boolean r8) throws java.security.GeneralSecurityException {
        /*
            ...
            monitor-enter(r0)
            java.util.concurrent.ConcurrentMap<java.lang.String, com.google.android.gms.internal.firebase-auth-api.zzbk> r1 = zzb     // Catch:{ all -> 0x008b }
            boolean r1 = r1.containsKey(r6)     // Catch:{ all -> 0x008b }
            if (r1 != 0) goto L_0x000d
            monitor-exit(r0)
            return
        L_0x000d:
            java.util.concurrent.ConcurrentMap<java.lang.String, com.google.android.gms.internal.firebase-auth-api.zzbk> r1 = zzb     // Catch:{ all -> 0x008b }
            java.lang.Object r1 = r1.get(r6)     // Catch:{ all -> 0x008b }
            com.google.android.gms.internal.firebase-auth-api.zzbk r1 = (com.google.android.gms.internal.p001firebaseauthapi.zzbk) r1     // Catch:{ all -> 0x008b }
            java.lang.Class r2 = r1.zzc()     // Catch:{ all -> 0x008b }
            boolean r2 = r2.equals(r7)     // Catch:{ all -> 0x008b }
            if (r2 != 0) goto L_0x0061
            java.util.logging.Logger r8 = zza     // Catch:{ all -> 0x008b }
            java.util.logging.Level r2 = java.util.logging.Level.WARNING     // Catch:{ all -> 0x008b }
            java.lang.String r3 = "Attempted overwrite of a registered key manager for key type "
            int r4 = r6.length()     // Catch:{ all -> 0x008b }
            if (r4 == 0) goto L_0x0030
            java.lang.String r3 = r3.concat(r6)     // Catch:{ all -> 0x008b }
            goto L_0x0036
        L_0x0030:
            java.lang.String r4 = new java.lang.String     // Catch:{ all -> 0x008b }
        ...
        L_0x0036:
            ...
            r8.logp(r2, r4, r5, r3)     // Catch:{ all -> 0x008b }
            java.security.GeneralSecurityException r8 = new java.security.GeneralSecurityException     // Catch:{ all -> 0x008b }
            r2 = 3
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ all -> 0x008b }
            r3 = 0
            r2[r3] = r6     // Catch:{ all -> 0x008b }
            r6 = 1
            java.lang.Class r1 = r1.zzc()     // Catch:{ all -> 0x008b }
            java.lang.String r1 = r1.getName()     // Catch:{ all -> 0x008b }
            r2[r6] = r1     // Catch:{ all -> 0x008b }
            r6 = 2
            java.lang.String r7 = r7.getName()     // Catch:{ all -> 0x008b }
            r2[r6] = r7     // Catch:{ all -> 0x008b }
            java.lang.String r6 = "typeUrl (%s) is already registered with %s, cannot be re-registered with %s"
            java.lang.String r6 = java.lang.String.format(r6, r2)     // Catch:{ all -> 0x008b }
            r8.<init>(r6)     // Catch:{ all -> 0x008b }
            throw r8     // Catch:{ all -> 0x008b }
        L_0x0061:
            if (r8 == 0) goto L_0x0089
            java.util.concurrent.ConcurrentMap<java.lang.String, java.lang.Boolean> r7 = zzd     // Catch:{ all -> 0x008b }
            java.lang.Object r7 = r7.get(r6)     // Catch:{ all -> 0x008b }
            java.lang.Boolean r7 = (java.lang.Boolean) r7     // Catch:{ all -> 0x008b }
            boolean r7 = r7.booleanValue()     // Catch:{ all -> 0x008b }
            if (r7 != 0) goto L_0x0089
            java.security.GeneralSecurityException r7 = new java.security.GeneralSecurityException     // Catch:{ all -> 0x008b }
            java.lang.String r8 = "New keys are already disallowed for key type "
            int r1 = r6.length()     // Catch:{ all -> 0x008b }
            if (r1 == 0) goto L_0x0080
            java.lang.String r6 = r8.concat(r6)     // Catch:{ all -> 0x008b }
            goto L_0x0085
        L_0x0080:
            java.lang.String r6 = new java.lang.String     // Catch:{ all -> 0x008b }
            r6.<init>(r8)     // Catch:{ all -> 0x008b }
        L_0x0085:
            r7.<init>(r6)     // Catch:{ all -> 0x008b }
