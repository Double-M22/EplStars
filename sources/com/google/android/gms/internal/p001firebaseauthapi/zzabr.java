...
interface zzabr {
    ...
    <T> void zzG(List<T> list, zzabs<T> zzabs, zzzq zzzq) throws IOException;

    @Deprecated
    <T> void zzH(List<T> list, zzabs<T> zzabs, zzzq zzzq) throws IOException;

    void zzI(List<zzzb> list) throws IOException;
    ...
    <T> T zzo(zzabs<T> zzabs, zzzq zzzq) throws IOException;

    @Deprecated
    <T> T zzp(zzabs<T> zzabs, zzzq zzzq) throws IOException;

    zzzb zzq() throws IOException;
